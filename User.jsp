	...
	<!-- Top box -->
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li"><a href="Admin.jsp" class="tm-nav-link">Admin</a></li>
                                                                   <li class="tm-nav-li"><a href="Owner.jsp" class="tm-nav-link ">Owner</a></li>
								<li class="tm-nav-li"><a href="User.jsp" class="tm-nav-link active">User</a></li>
							</ul>
						</nav>	
					</div>
				</div>
		...
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">User Login</h2>
                                 <center>
                                <form action="LoginAction.jsp" method="post">
                                    <table>
                                        <tr>
                                         ...
                                         <tr>
                                            <th></th><td><input type="submit" value="Login">
                                                <input type="reset" value="Reset"><a href="Register.jsp">Register</a></td>
                                        </tr>
                                    </table>
                                </form>
