					...
					<div class="row tm-header-inner">
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li"><a href="Viewusers.jsp" class="tm-nav-link">View Users</a></li>
                                                           	<li class="tm-nav-li"><a href="ViewOwner.jsp" class="tm-nav-link">View Owners</a></li>
                                                                <li class="tm-nav-li"><a href="ViewFrauds.jsp" class="tm-nav-link">View Frauds</a></li>
