					...
					<div class="row tm-header-inner">
						...
						<nav class="col-md-6 col-12 tm-nav">
							<ul class="tm-nav-ul">
								...
								<li class="tm-nav-li"><a href="Viewusers.jsp" class="tm-nav-link active">ViewUsers</a></li>
			...
			<header class="row tm-welcome-section">
                                 ...
                                 <center>
                                     ...
                                     <table border="1">
                                         ...
                                         <%
                                         try{
                                          ResultSet r=Queries.getExecuteQuery("select * from register where usertype='User'");
                                          while(r.next()){
                                              %>
                                              <tr>
